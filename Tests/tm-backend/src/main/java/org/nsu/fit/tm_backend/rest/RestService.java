...
public class RestService {
    ...
    public Response createCustomer(CustomerPojo1 customerData1) {
        try {
            CustomerPojo customerData = new CustomerPojo();
            customerData.id = customerData1.id;
            customerData.balance = customerData1.balance;
            customerData.firstName = customerData1.firstName;
            customerData.lastName = customerData1.lastName;
            customerData.login = customerData1.login;
            customerData.password = customerData1.password;
            // create new customer
